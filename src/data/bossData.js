...
export const bossesData = [
  ...
  },
  {
    ...
    defaultImg: "/src/assets/images/boss/Boss2_0.webp",
    defaultDesc: `二人组似乎都是树蛙。呱呱为棕色，穿着栗色腰带；利比是个矮一些的绿色树蛙，穿着红色拳套与白色裤子。`,
    phases: {
      1: { 
        img: "/src/assets/images/boss/Boss2_1.webp", 
        desc: `阶段 1：两只树蛙轮流攻击。呱呱会吐出萤火虫进行自杀式撞击，利比则会打出有规律的能量波型拳头。` 
      },
      2: { 
        img: "/src/assets/images/boss/Boss2_2.webp", 
        desc: `阶段 2：利比在左，呱呱在右包围玩家。利比拍出弹跳球，呱呱则变身风扇试图将玩家吹向利比。` 
      },
      3: { 
        img: "/src/assets/images/boss/Boss2_3.webp", 
  ...
  },
  {
    ...
    defaultImg: "/src/assets/images/boss/Boss5_0.webp",
    defaultDesc: `蜂后是一只非常巨大的女王蜂，穿着黑色和黄色条纹的钟形连衣裙，手里通常拿着蜂蜜棒。`,
    phases: {
      1: { 
        img: "/src/assets/images/boss/Boss5_1.webp", 
        desc: `阶段 1：蜂后派出警蜂，放置并在5秒后爆炸的蜜蜂炸弹。疲惫的工蜂也会拿着手提箱在屏幕中穿梭作为障碍。` 
      },
      2: { 
        img: "/src/assets/images/boss/Boss5_2.webp", 
        desc: `阶段 2：蜂后亲自上场，使用蜂蜜棒施展法术：发射尖锐的"魔三角"或者追踪玩家的"紫色魔光球"。` 
      },
      3: { 
        img: "/src/assets/images/boss/Boss5_3.webp", 
...
/**
 * 根据 ID 获取 Boss
 * @param {number} id - Boss ID
 */
export function getBossById(id) {
  return bossesData.find(boss => boss.id === id);
}
